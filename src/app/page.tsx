...
function FAQ() {
  ...
  const faqs = [
    ...
    { q: 'What does it cost?', a: 'Simple and transparent: a one-time $1,000 setup fee to build and launch your campaign, and a $2,000/month retainer that starts 45 days after you pay the setup fee. The first 14 days are email warmup. The next 30 days are active prospecting — completely free. No contracts. Cancel anytime.' },
